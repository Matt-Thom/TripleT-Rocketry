/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ffb5ab3c1bf9b1f03f10b4c3e7d6899f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PROJECT_ID">> {}
}
